...
### Added
- Temporary download links for a newer compiled wally-package-types

### Fixed
- Potential bug with client failing to access a game's service out of studio (fixes [#1](https://github.com/StevenDahFish/fish/issues/1))

### Removed
- Unused ReplicatedStorage reference from Client
